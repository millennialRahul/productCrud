   ...
   <div class="m-content ">
      ...
      <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
         ...
         <div class="tab-content">
            <form class="m-form m-form--fit m-form--label-align-right" action="#" enctype="multipart/form-data" method="post" id="myform">
            <div class="m-portlet__body">
               ...
               <div class="form-group m-form__group row">
                  ...
                  <div class="col-7">
                      <input type="number" class="form-control m-input" name="quantity" id="quantity">
                  </div>
               </div>
               <div class="form-group m-form__group row">
                  <label for="example-text-input" class="col-2 col-form-label">
                  ...
                  <div class="col-7">
                     <input type="textarea" class="form-control m-input" row="3" name="description" id="description">
                  </div>
               </div>
               <div class="form-group m-form__group row">
                  <label for="example-text-input" class="col-2 col-form-label">
                  ...
                  <div class="col-7">
                  <input type="number" class="form-control m-input" name="price" id="price">
                  </div>
               </div>
               <div class="form-group m-form__group row">
                  <label for="example-text-input" class="col-2 col-form-label">
